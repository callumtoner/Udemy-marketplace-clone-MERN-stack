...
//remember you're taking the values from [slug].js as props here for this to run
const AddLessonForm = ({
        values, setValues, handleAddLesson, uploading, uploadButtonText, handleVideo, progress, handleVideoRemove
}) => {
    return <div className="container pt-3">
            ...
            <form onSubmit={handleAddLesson}>
                ...
                <textarea className="form-control mt-3" id="" cols="7" rows="7" onChange={e => setValues({...values, content : e.target.value})} value={values.content} placeholder="Content"></textarea>
                <div className="d-flex justify-content-center">
                <label className="bt btn-dark btn-block text-left mt-3">
                  {uploadButtonText}
